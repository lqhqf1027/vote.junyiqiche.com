define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activityvotingrecord/index',
                    add_url: 'activityvotingrecord/add',
                    edit_url: 'activityvotingrecord/edit',
                    del_url: 'activityvotingrecord/del',
                    multi_url: 'activityvotingrecord/multi',
                    table: 'voting_record',
                }
            });
