<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\phpStudy\WWW\yinchuan.junyiqiche.com\public/../application/index\view\index\ranking.html";i:1547433992;s:85:"D:\phpStudy\WWW\yinchuan.junyiqiche.com\application\index\view\vote\layoutextend.html";i:1546949393;s:79:"D:\phpStudy\WWW\yinchuan.junyiqiche.com\application\index\view\vote\header.html";i:1547434685;s:79:"D:\phpStudy\WWW\yinchuan.junyiqiche.com\application\index\view\vote\footer.html";i:1547436661;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
.pd_tb10-lr0{
    ...
    .user-list .first .rank, .user-list .second .rank, .user-list .third .rank {
        line-height: 2rem;
        background-size: 100%;
        color: #fff;
    }
    .user-list .first .rank {
        background-image: url(http://cdn.51wyfl.com/web/images/icon/first.png);
    }
    .user-list .second .rank {
        background-image: url(http://cdn.51wyfl.com/web/images/icon/second.png);
    }
    .user-list .third .rank {
        background-image: url(http://cdn.51wyfl.com/web/images/icon/third.png);
    }
    .user-list .user .rank {
        width: 2rem;
        height: 2.5rem;
    ...
    .user-list .first .coupons, .user-list .second .coupons, .user-list .third .coupons {
        color: #FE8282;
    }
...
<!-- <ul class="flow-default" id="rank-list"></ul> -->
<div class="contain">
    <div class="user-list">
